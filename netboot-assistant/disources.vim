...
"syn match diSourcesArchs        /\(alpha\|amd64\|arm\|armel\|hppa\|i386\|ia64\|lpia\|mips\|mipsel\|powerpc\|sparc\)/
...
syn match diSourcesDistrKeyword   +\([[:alnum:]_./]*\)\(sarge\|etch\|lenny\|squeeze\|\(old\)\=stable\|testing\|unstable\|daily\|sid\|experimental\|dapper\|edgy\|feisty\|gutsy\|hardy\|intrepid\|jaunty\)\([-[:alnum:]_./]*\)+
